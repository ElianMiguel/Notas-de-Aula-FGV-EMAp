...
\section{Exercícios}
\textbf{Importante:} Alguns dos exercícios são baseados em \cite{axler2026}.

\noindent $\mathbf{6.1)}$ Considere a transformação $T:\mathbb{R}\to\mathbb{R}^3$ definida por:
...
$\\$
$\mathbf{6.2)}$ Prove que a transformação $T:\mathcal{P}_n\to\mathbb{R}$, definida como:

$$
T(p) = \displaystyle \int_{0}^{1} p(x) \,dx
$$
é uma transformação linear.

$\\$
$\mathbf{6.3)}$ Por que a transformação $T:\mathcal{P}_n\to\mathcal{P}_{n + 1}$, definida por:
...
$\\$
$\mathbf{6.4)}$ Considere a transformação linear $T:\mathbb{R}^3\to\mathbb{R}^2$, dada por:
...
$\\$
$\mathbf{6.5)}$ Considere a transformação linear $T:\mathcal{P}_n\to\mathcal{P}_{n + 1}$ definida por:

$$
T(p) = \displaystyle \int_{0}^{x} p(t) \,dt.
$$
Encontre o núcleo e a imagem de $T$. Esta transformação é injetiva? Ela é sobrejetiva?

$\\$
$\mathbf{6.6)}$ Suponha que $V$ e $W$ são dois espaços vetoriais tais que $\dim V > \dim W$. Prove que nenhuma transformação linear $T:V\to W$ é injetiva.

$\\$
$\mathbf{6.7)}$ Suponha que $V$ e $W$ são dois espaços vetoriais tais que $\dim V < \dim W$. Prove que nenhuma transformação linear $T:V\to W$ é sobrejetiva.

$\\$
$\mathbf{6.8)}$ Considere a transformação linear $D:\mathcal{P}_{n}\to\mathcal{P}_{n - 1}$ definida por:
...
$\\$
$\mathbf{6.9)}$ Considere uma transformação linear $T:V\to V$ qualquer. Prove que a transformação $T^n:V\to V$, definida como:

$$
T^n(x) = \underbrace{T\circ T\circ\cdots\circ T}_{n\text{ vezes }}
$$
...
$\\$
$\mathbf{6.10)}$ Considere a transformação linear $T:\mathbb{R}^2\to\mathbb{R}^2$ definida como:
...
$\\$
$\mathbf{6.11)}$ Prove que $\mathcal{P}_n\cong\mathbb{R}^{n + 1}$ de duas formas:
...
$\\$
$\mathbf{6.12)}$ Demonstre que $\mathbb{R}^n\cong\mathbb{C}^m$ se, e somente se, $n = 2m$.

$\\$
$\mathbf{6.13)}$ Demonstre que $\mathbb{R}^{m\times n}\cong\mathbb{R}^{mn}$ exibindo um isomorfismo explícito entre os dois espaços.

$\\$
$\mathbf{6.14)}$ Demonstre que a transformação linear $T:\mathbb{R}^2\to\mathbb{R}^2$ definida como:
...
$\\$
$\mathbf{6.15)}$ Considere as duas seguintes bases para $\mathbb{R}^2$: $\mathcal{U} = \left\{\begin{bmatrix}
	1 \\
	1
\end{bmatrix}, \begin{bmatrix}
	2 \\
	0
\end{bmatrix}\right\}$ e $\mathcal{V} = \left\{\begin{bmatrix}
	1 \\
	5
\end{bmatrix}, \begin{bmatrix}
	2 \\
...
c) Considere o vetor $[x]_\mathcal{U} = \begin{bmatrix}
	5 \\
	3
\end{bmatrix}$. Encontre $[x]_\mathcal{V}$.
