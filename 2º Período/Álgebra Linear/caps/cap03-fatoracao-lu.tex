...
\begin{Proof}
	...
	\textbf{Unicidade:} Agora, considerando as mesmas hipóteses para $A$, nós vamos demonstrar a unicidade da fatoração $LU$. Suponha que $A = LU = \hat{L}\hat{U}$. Então, $I = L^{-1}LUU^{-1} = L^{-1}\hat{L}\hat{U}U^{-1}$. Segue então que $\hat{U}U^{-1} = (L^{-1}\hat{L})^{-1} = \hat{L}^{-1}L$. 
